//TODO
//As of 1/21/22 this is just an exact replica of modify_estimate_screen.dart
...
class _ModifyEstimateScreenState extends State<ModifyEstimateScreen> {
  ...
  int checkNamingNumber() {
    // not the most ideal, will replace later with better solution
    var newNum = 0;
    List<int> listCurNum = [];
